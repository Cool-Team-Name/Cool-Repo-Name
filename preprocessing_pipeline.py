...
execfile('get_submission_data.py')
...
LEARNING_RATE = 1e-3
N_TRAIN_STEPS = 1
TRAIN_PATH = 'tsa_logs/zone5_train/'
MODEL_PATH = 'tsa_logs/zone5_model/'
#EDITED FOR ZONE 5
...
def input_pipeline(filename, path):
    ...
    # grab slice 0 scans only
    # feature_batch = feature_batch[0]
